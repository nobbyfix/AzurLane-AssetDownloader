...
This tool automatically downloads the newest assets directly from the game cdn servers and allows extraction of Texture2D files as png from them.
...
While this is *not neccessary*, this step is **recommended** if you want all game assets available and not spam the game update server with errors of missing files on the first download.
